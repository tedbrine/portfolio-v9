...
export const BastBanner = () => {
  return (
    <ContentBox
      className="relative overflow-hidden px-6 py-2.5 sm:px-10 sm:py-3"
      position="middle"
    >
      ...
      <div className="relative flex flex-col items-center justify-center gap-2 text-center sm:flex-row sm:gap-3">
        ...
        <Link
          ...
          className="group inline-flex items-center gap-1.5 font-medium text-sm text-white transition-opacity hover:opacity-80"
        >
          Check out now
